  ...
  factory: (require) => {
    ...
    function createPanel(ctx, deps) {
      ...
      function Panel() {
        ...
        /**
         * Hand the skill over to the site that documents it.
         *
         ...
         * decision has been made, and the archive fallback made that worse by
         * extracting a whole repository into the temp directory. A new tab costs
         * nothing and leaves the judgement where it belongs.
         */
        const onView = (item) => {
          const url = 'https://www.skills.sh/' + keyOf(item);
          ...
          const kids = [
            ...
            h('div', { className: 'dshsk-bar', key: 'b' },
              h('button', { className: 'dshsk-btn', key: 'pv',
                onClick: function () { onView(r); } }, tt('view')),
